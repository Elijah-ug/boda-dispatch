...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-950 text-gray-300 py-10 px-4 text-sm">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-sm">
          ...
          <a href="https://www.linkedin.com/in/mugisha-elijah-88a291239/" target='_blank' className="transition-colors duration-200">
            <FaLinkedin />
          </a>
